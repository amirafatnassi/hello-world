...
function sals(t, l, c, s, z, id) {
  var sal = document.getElementsByClassName(id); //id – class – Our chosen class name
  sal[0].style.top = t; //t – top – How many pixels from the top of the screen
  sal[0].style.left = l; //l – left – How many pixels from the left of the screen
  sal[0].style.color = c; //c – colour – What colour to display the text in
  sal[0].style.fontSize = c; //s - font-size – The desired font size
  sal[0].style.zindex = z; //z - z-index – Overlay level – 1 appears in front of 0
}
